...
from usdchat_webui.components import loading_icon
from usdchat_webui.state import QA, State
...
def action_bar() -> rx.Component:
    ...
    return rx.box(
        rx.vstack(
            ...
            rx.text(
                "Usdchat may return factually incorrect or misleading responses. Use discretion.",
                font_size="xs",
                color="#fff6",
                text_align="center",
            ),
