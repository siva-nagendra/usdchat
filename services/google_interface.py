...
def fetch_google_search_results(
    ...
    headers = {
        ...
        or "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/93.0.4577.63 Safari/537.36"
    }
...
def parse_organic_results(html_content):
    ...
    for result in soup.select(".tF2Cxc"):
        ...
        snippet = (
            result.select_one(".VwiC3b.MUxGbd").text
            if result.select_one(".VwiC3b.MUxGbd")
            else None
        )
